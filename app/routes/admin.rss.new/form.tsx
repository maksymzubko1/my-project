...
const Form = () => {
  ...
  const onSubmitFunction = useCallback((event: FormEvent<HTMLFormElement> | null, action?: "fetch_rss" | "create") => {
  ...
  return (
    <RemixForm
      ...
      <div className={"flex flex-col gap-3 items-start"}>
        ...
        />
        <Button loading={isLoading} onClick={fetchRss} variant={"primary"}>Fetch</Button>
      </div>
